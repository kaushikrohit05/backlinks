...
<div class="row">
    ...
    <div class="col-md-12">
        ...
        <div class="mb-3">
            ...
            <input  type="date" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"   name="transaction_date" placeholder="Transaction Date" value="{{ old('transaction_date') }}">
    ...
    <div class="mb-3">
      ...
      <input type="date" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="expiry_date" placeholder="Expiry Date" value="{{ old('expiry_date') }}">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="price" placeholder="Price" value="{{ old('price') }}">
